...
class PharmacyRegister extends StatefulWidget {
  ...
  static final routeName = './PharmacyRegister';
...
class _PharmacyRegisterState extends State<PharmacyRegister> {
  ...
  final _specialised = TextEditingController();
            ...
            child: Padding(
              ...
              child: Column(
                  ...
                  children: <Widget>[
                    ...
                    //   // obscureText: true,
                    //   keyboardType: TextInputType.emailAddress,
                    //   controller: _specialised,
                    //   validator: (value) {
                    //     if (value.trim().isEmpty) {
                    //       return 'Please enter  specialised';
                    //     }
                    //     return null;
                    //   },
                    //   decoration: InputDecoration(
                    //     border: OutlineInputBorder(),
                    //     labelText: 'Specialised in',
                    //   ),
                    // ),
                    // SizedBox(
                    //   height: 15,
                              ...
                              if (_formkey.currentState.validate()) {
                                ...
                                await auth
                                  ...
                                  var data = {
                                    ...
                                    "id": userId,
                                    "pharmacy_id": pharmacyid.text.toString() +
                                        "" +
                                        userId.toString(),
                                    "dob": _dob,
                                  };
